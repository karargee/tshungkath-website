          ...
          <div className="gallery-content hidden" id="galleryContent">
            <div className="gallery-grid">
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=Gallery+1')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=Gallery+1" alt="Gallery Image" loading="lazy" />
              ...
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=Gallery+2')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=Gallery+2" alt="Gallery Image" loading="lazy" />
                <div className="media-type">📷</div>
              </div>
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=Dungeon+Equipment')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=Dungeon+Equipment" alt="Dungeon Equipment" loading="lazy" />
                <div className="media-type">📷</div>
              </div>
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=BDSM+Gear')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=BDSM+Gear" alt="BDSM Equipment" loading="lazy" />
                <div className="media-type">📷</div>
              </div>
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=Sissy+Training')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=Sissy+Training" alt="Sissy Training" loading="lazy" />
                <div className="media-type">📷</div>
              </div>
              <div className="gallery-item" onClick={() => window.openLightbox('https://via.placeholder.com/300x400/ff1493/ffffff?text=Kathy+Photo')}>
                <img src="https://via.placeholder.com/300x400/ff1493/ffffff?text=Kathy+Photo" alt="Kathy Photo" loading="lazy" />
                <div className="media-type">📷</div>
              </div>
            </div>
          </div>
